...
// .wrangler/tmp/bundle-Cso8gU/checked-fetch.js
...
// .wrangler/tmp/pages-NkwgDb/functionsWorker-0.9936857630953877.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-FbNc0o/checked-fetch.js"() {
    "use strict";
...
var init_summary = __esm({
  "api/summary.ts"() {
    "use strict";
    init_functionsRoutes_0_7418773368431171();
    init_checked_fetch();
...
var require_logging = __commonJS({
  "../node_modules/@notionhq/client/build/src/logging.js"(exports) {
    ...
    __name2(makeConsoleLogger, "makeConsoleLogger");
    ...
    __name2(logLevelSeverity, "logLevelSeverity");
...
var require_errors = __commonJS({
  "../node_modules/@notionhq/client/build/src/errors.js"(exports) {
    ...
    var NotionClientErrorBase = class extends Error {
      ...
      static {
        __name2(this, "NotionClientErrorBase");
      }
    };
    ...
    var HTTPResponseError = class extends NotionClientErrorBase {
      ...
      static {
        __name2(this, "HTTPResponseError");
      }
      constructor(args) {
        super(args.message);
    ...
    __name2(isHTTPResponseError, "isHTTPResponseError");
    ...
    var UnknownHTTPResponseError = class extends HTTPResponseError {
      ...
      static {
        __name2(this, "UnknownHTTPResponseError");
      }
      constructor(args) {
        var _a;
        super({
    ...
    __name2(buildRequestError, "buildRequestError");
    ...
    __name2(parseAPIErrorResponseBody, "parseAPIErrorResponseBody");
    function isAPIErrorCode(code) {
      return typeof code === "string" && code in apiErrorCodes;
    }
    __name(isAPIErrorCode, "isAPIErrorCode");
    __name2(isAPIErrorCode, "isAPIErrorCode");
  }
});
var require_api_endpoints = __commonJS({
  "../node_modules/@notionhq/client/build/src/api-endpoints.js"(exports) {
    ...
    exports.getSelf = {
      ...
      queryParams: [],
      bodyParams: [],
      path: /* @__PURE__ */ __name2(() => `users/me`, "path")
    };
    exports.getUser = {
      method: "get",
      pathParams: ["user_id"],
      queryParams: [],
      bodyParams: [],
      path: /* @__PURE__ */ __name2((p) => `users/${p.user_id}`, "path")
    };
    exports.listUsers = {
      method: "get",
      pathParams: [],
      ...
      bodyParams: [],
      path: /* @__PURE__ */ __name2(() => `users`, "path")
    };
    exports.createPage = {
      method: "post",
      pathParams: [],
      ...
      path: /* @__PURE__ */ __name2(() => `pages`, "path")
    };
    exports.getPage = {
      method: "get",
      pathParams: ["page_id"],
      ...
      bodyParams: [],
      path: /* @__PURE__ */ __name2((p) => `pages/${p.page_id}`, "path")
    };
    exports.updatePage = {
      method: "patch",
      pathParams: ["page_id"],
    ...
    exports.getPageProperty = {
      ...
      queryParams: ["start_cursor", "page_size"],
      bodyParams: [],
      path: /* @__PURE__ */ __name2((p) => `pages/${p.page_id}/properties/${p.property_id}`, "path")
    };
    exports.getBlock = {
      method: "get",
      pathParams: ["block_id"],
      queryParams: [],
      bodyParams: [],
      path: /* @__PURE__ */ __name2((p) => `blocks/${p.block_id}`, "path")
    };
    exports.updateBlock = {
      method: "patch",
      pathParams: ["block_id"],
    ...
    exports.listBlockChildren = {
      ...
      queryParams: ["start_cursor", "page_size"],
      bodyParams: [],
      path: /* @__PURE__ */ __name2((p) => `blocks/${p.block_id}/children`, "path")
    };
    ...
    exports.getDatabase = {
      ...
      queryParams: [],
      bodyParams: [],
      path: /* @__PURE__ */ __name2((p) => `databases/${p.database_id}`, "path")
    };
    ...
    exports.queryDatabase = {
      ...
      path: /* @__PURE__ */ __name2((p) => `databases/${p.database_id}/query`, "path")
    };
    exports.listDatabases = {
      ...
      queryParams: ["start_cursor", "page_size"],
      bodyParams: [],
      path: /* @__PURE__ */ __name2(() => `databases`, "path")
    };
    ...
    exports.search = {
      ...
      path: /* @__PURE__ */ __name2(() => `search`, "path")
    };
    exports.createComment = {
      ...
      path: /* @__PURE__ */ __name2(() => `comments`, "path")
    };
...
var require_browser = __commonJS({
  "../node_modules/node-fetch/browser.js"(exports, module) {
    ...
    init_functionsRoutes_0_7418773368431171();
    init_checked_fetch();
    var getGlobal = /* @__PURE__ */ __name2(function() {
    ...
    var Client2 = class _Client {
      ...
      constructor(options) {
        ...
        this.blocks = {
           ...
           * Retrieve block
           */
          retrieve: /* @__PURE__ */ __name2((args) => {
            return this.request({
...
var require_helpers = __commonJS({
  "../node_modules/@notionhq/client/build/src/helpers.js"(exports) {
    ...
    __name2(iteratePaginatedAPI, "iteratePaginatedAPI");
...
var require_src = __commonJS({
  "../node_modules/@notionhq/client/build/src/index.js"(exports) {
    ...
    Object.defineProperty(exports, "Client", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return Client_1.default;
    }, "get") });
    var logging_1 = require_logging();
    Object.defineProperty(exports, "LogLevel", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return logging_1.LogLevel;
    }, "get") });
    var errors_1 = require_errors();
    Object.defineProperty(exports, "APIErrorCode", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return errors_1.APIErrorCode;
    }, "get") });
    Object.defineProperty(exports, "ClientErrorCode", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return errors_1.ClientErrorCode;
    }, "get") });
    Object.defineProperty(exports, "APIResponseError", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return errors_1.APIResponseError;
    }, "get") });
    Object.defineProperty(exports, "UnknownHTTPResponseError", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return errors_1.UnknownHTTPResponseError;
    }, "get") });
    Object.defineProperty(exports, "RequestTimeoutError", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return errors_1.RequestTimeoutError;
    }, "get") });
    Object.defineProperty(exports, "isNotionClientError", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return errors_1.isNotionClientError;
    }, "get") });
    var helpers_1 = require_helpers();
    Object.defineProperty(exports, "collectPaginatedAPI", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return helpers_1.collectPaginatedAPI;
    }, "get") });
    Object.defineProperty(exports, "iteratePaginatedAPI", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return helpers_1.iteratePaginatedAPI;
    }, "get") });
    Object.defineProperty(exports, "isFullBlock", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return helpers_1.isFullBlock;
    }, "get") });
    Object.defineProperty(exports, "isFullDatabase", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return helpers_1.isFullDatabase;
    }, "get") });
    Object.defineProperty(exports, "isFullPage", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return helpers_1.isFullPage;
    }, "get") });
    Object.defineProperty(exports, "isFullUser", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
      return helpers_1.isFullUser;
    }, "get") });
    Object.defineProperty(exports, "isFullComment", { enumerable: true, get: /* @__PURE__ */ __name2(function() {
...
var require_markdown_table = __commonJS({
  "../node_modules/markdown-table/index.js"(exports, module) {
    ...
    __name2(markdownTable, "markdownTable");
...
var require_md = __commonJS({
  "../node_modules/notion-to-md/build/utils/md.js"(exports) {
    ...
    var inlineCode = /* @__PURE__ */ __name2((text) => {
      return `\`${text}\``;
    }, "inlineCode");
    exports.inlineCode = inlineCode;
    var inlineEquation = /* @__PURE__ */ __name2((text) => {
      return `$${text}$`;
    }, "inlineEquation");
    exports.inlineEquation = inlineEquation;
    var bold = /* @__PURE__ */ __name2((text) => {
      return `**${text}**`;
    }, "bold");
    exports.bold = bold;
    var italic = /* @__PURE__ */ __name2((text) => {
      return `_${text}_`;
    }, "italic");
    exports.italic = italic;
    var strikethrough = /* @__PURE__ */ __name2((text) => {
      return `~~${text}~~`;
    }, "strikethrough");
    exports.strikethrough = strikethrough;
    var underline = /* @__PURE__ */ __name2((text) => {
      return `<u>${text}</u>`;
    }, "underline");
    exports.underline = underline;
    var link = /* @__PURE__ */ __name2((text, href) => {
      return `[${text}](${href})`;
    }, "link");
    exports.link = link;
    var codeBlock = /* @__PURE__ */ __name2((text, language) => {
      if (!text)
        return "";
...
\`\`\``;
    ...
    var equation = /* @__PURE__ */ __name2((text) => {
      return `$$
${text}
$$`;
    }, "equation");
    exports.equation = equation;
    var heading1 = /* @__PURE__ */ __name2((text) => {
      return `# ${text}`;
    }, "heading1");
    exports.heading1 = heading1;
    var heading2 = /* @__PURE__ */ __name2((text) => {
      return `## ${text}`;
    }, "heading2");
    exports.heading2 = heading2;
    var heading3 = /* @__PURE__ */ __name2((text) => {
      return `### ${text}`;
    }, "heading3");
    exports.heading3 = heading3;
    var quote = /* @__PURE__ */ __name2((text) => {
      return `> ${text.replace(/\n/g, "  \n> ")}`;
    }, "quote");
    exports.quote = quote;
    var callout = /* @__PURE__ */ __name2((text, icon) => {
      let emoji;
    ...
    var bullet = /* @__PURE__ */ __name2((text, count) => {
      let renderText = text.trim();
      return count ? `${count}. ${renderText}` : `- ${renderText}`;
    }, "bullet");
    exports.bullet = bullet;
    var todo = /* @__PURE__ */ __name2((text, checked) => {
      return checked ? `- [x] ${text}` : `- [ ] ${text}`;
    }, "todo");
    exports.todo = todo;
    var image = /* @__PURE__ */ __name2(async (alt, href, convertToBase64 = false) => {
    ...
    exports.image = image;
    var addTabSpace = /* @__PURE__ */ __name2((text, n = 0) => {
      const tab = "    ";
      for (let i = 0; i < n; i++) {
        if (text.includes("\n")) {
...
${tab}`);
    ...
    var divider = /* @__PURE__ */ __name2(() => {
      return "---";
    }, "divider");
    exports.divider = divider;
    var toggle = /* @__PURE__ */ __name2((summary, children) => {
      if (!summary)
        return children || "";
      return `<details>
...
`;
    ...
    var table = /* @__PURE__ */ __name2((cells) => {
...
var require_notion = __commonJS({
  "../node_modules/notion-to-md/build/utils/notion.js"(exports) {
    ...
    var getBlockChildren = /* @__PURE__ */ __name2(async (notionClient, block_id, totalPage) => {
      let result = [];
      let pageCount = 0;
    ...
    var modifyNumberedListObject = /* @__PURE__ */ __name2((blocks) => {
...
var require_notion_to_md = __commonJS({
  "../node_modules/notion-to-md/build/notion-to-md.js"(exports) {
    ...
    var NotionToMarkdown2 = class {
      static {
        __name(this, "NotionToMarkdown2");
      }
      static {
        __name2(this, "NotionToMarkdown");
      }
      constructor(options) {
...
var routes;
var init_functionsRoutes_0_7418773368431171 = __esm({
  "../.wrangler/tmp/pages-NkwgDb/functionsRoutes-0.7418773368431171.mjs"() {
    "use strict";
    init_summary();
    init_translate();
    routes = [
...
// .wrangler/tmp/bundle-Cso8gU/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Cso8gU/middleware-loader.entry.ts
...
repeat-string/index.js:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.9936857630953877.js.map
